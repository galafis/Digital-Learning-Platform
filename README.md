...
**Digital Learning Platform** — Professional project by Gabriel Demetrios Lafis

Total source lines: **842** across **5** files in **5** languages.
...
Total de linhas de código: **842** em **5** arquivos em **5** linguagens.
